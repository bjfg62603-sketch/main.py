...
app.run_polling() вот смотри это код от моего осинт бота как то соедени эти два бота в один и ещё добавь команду .докс и бот будет использовать этот бот для поиска инфы
