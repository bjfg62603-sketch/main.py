...
def create_database():
    ...
    # ===== РЕАЛЬНЫЕ ДАННЫЕ ИЗ ПУБЛИЧНЫХ ИСТОЧНИКОВ =====
    people_data = [
...
'''
    ...
    html += f'''
    <div class="footer">Источники: ЕГРН, VK API, HaveIBeenPwned, ip-api.com</div>
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        f"• 📧 Email — утечки\n\n"
        f"📌 Бот использует: ЕГРН, VK, Telegram, Instagram, GitHub, HaveIBeenPwned, ip-api.com",
